...
//        saving players names in variables
        ...
        txtPlayer2.setText(R.string.computer);
        ...
        if (!gameEnded) {
            ...
            if (btnCurrent.getText().toString().isEmpty()) {
                ...
                if (flag == 0) {
                    ...
                    result.setText(R.string.computer_turn);
                    flag = 1;
...
//    check for winner and handle game end
...
//    make computer move
    private void makeComputerMove(){
        // Get all available empty buttons
        List<Button> emptyButtons = new ArrayList<>();
        if (btn1.getText().toString().isEmpty()) emptyButtons.add(btn1);
        if (btn2.getText().toString().isEmpty()) emptyButtons.add(btn2);
        if (btn3.getText().toString().isEmpty()) emptyButtons.add(btn3);
        if (btn4.getText().toString().isEmpty()) emptyButtons.add(btn4);
        if (btn5.getText().toString().isEmpty()) emptyButtons.add(btn5);
        if (btn6.getText().toString().isEmpty()) emptyButtons.add(btn6);
        if (btn7.getText().toString().isEmpty()) emptyButtons.add(btn7);
        if (btn8.getText().toString().isEmpty()) emptyButtons.add(btn8);
        if (btn9.getText().toString().isEmpty()) emptyButtons.add(btn9);

        if (!emptyButtons.isEmpty()) {
            Button randomButton = emptyButtons.get(random.nextInt(emptyButtons.size()));
